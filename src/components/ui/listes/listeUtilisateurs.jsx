    ...
    <div className="w-full overflow-x-scroll">
      <table className="w-full border-separate border-spacing-y-2">
        <thead className="bg-whiteColor">
          ...
          <th className="py-4 text-center w-40 text-blackColor font-semibold text-sm rounded-tr-lg ">
            {t("Action")}
          </th>
        </thead>
        <tbody className="">
          {donnees.map((e) => (
            <tr key={e.id} className="bg-whiteColor">
              <td className="py-4 min-w-[250px] text-center text-textGreyColor font-medium text-sm rounded-lg">
                {e.first_name} {e.last_name}
              </td>
              <td className="py-4 min-w-[100px] text-center text-textGreyColor font-medium text-sm ">
                {e.telephone}
              </td>
              <td className="py-4 min-w-[150px] text-center text-textGreyColor font-medium text-sm ">
                {e.etablissement
                  ? e.etablissement.code_etablissement
                  : t("Trésor")}
              </td>
