    ...
    <div className="w-full overflow-x-scroll">
      <table className="w-full border-separate border-spacing-y-2">
        <thead className="bg-whiteColor">
          <th className="py-4 text-center min-w-[100px] text-blackColor font-semibold text-sm rounded-tl-lg">
            {t("Code")}
          </th>
          <th className="py-4 text-center min-w-[300px] text-blackColor font-semibold text-sm ">
            {t("Nom")}
          </th>
