...
export const ListeCheques = ({ donnees, setDonnees }) => {
    ...
    <div className="w-full overflow-x-scroll">
      <table className="w-full border-separate border-spacing-y-2">
        <thead className="bg-whiteColor">
          ...
          <th className="py-4 min-w-[200px] text-center text-blackColor font-semibold text-sm ">
            {t("Nom")}
          </th>
          <th className="py-4 min-w-[100px] text-center text-blackColor font-semibold text-sm ">
            {t("Montant")}
          </th>
